...
# -*- encoding: utf-8 -*-
# stub: fluentd-plugin-cassandra 1.0.0 ruby lib

$:.push File.expand_path('../lib', __FILE__)
Gem::Specification.new do |s|
  s.name = "fluentd-plugin-cassandra".freeze
  s.version = "1.0.0"
  ...
  s.files = [
    ...
    "Rakefile",
    "VERSION",
    "fluentd-plugin-cassandra.gemspec",
    "lib/fluent/plugin/out_cassandra_driver.rb",
    "spec/spec.opts",
    "spec/spec_helper.rb",
    "lib/fluent/plugin/filter_cassandra_filter.rb",
    "lib/fluent/plugin/filter_example.rb"
  ]
  s.homepage = "https://github.com/CSharpRU/fluentd-plugin-cassandra".freeze
